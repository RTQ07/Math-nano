...
encoded_chunks = []
checkpoint_interval = 1000  # Save checkpoint every 100 chunks
checkpoint_path = 'mathpile_val_encoded_checkpoint.pt'
...
with open('val_temp_preprocessed_dataset.txt', 'r') as file:
...
torch.save(encoded_dataset, 'mathpile_val_encoded.pt')
